            ...
            <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="sectionCard mb-4">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            {{-- <x-input name="sku" placeholder="Product SKU" label="Product  SKU" class="form-control mb-4" :required="true"></x-input> --}}
                        ...
                        <div class="col-md-6 mb-4">
                            <x-input type="number" name="by_price" placeholder="Product Buying Price"
                                label="Product Buying Price" class="form-control "></x-input>
                        </div>
                        <div class="col-md-6 mb-4">
                            <x-input type="number" name="sale_price" placeholder="Product Sale Price"
                ...
                <div class="sectionCard mb-4">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <label for="thumbnail">
                                <img src="{{ asset('admin/assets/images/upload.png') }}" alt="" width="140"
                                    height="140" class="img-tmumbnail" id="thumbnailPreview">
                            </label>
