                ...
                <div class="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="widget instagram">
                        ...
                        <ul class="d-flex">
                            ...
                            <li><a href="project-single.html"><img
                                        src="{{ asset('web/assets/images/instragram/4.jpg') }}" alt=""></a>
                            </li>
                            <li><a href="project-single.html"><img
                                        src="{{ asset('web/assets/images/instragram/1.jpg') }}" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col col-xs-12">
                    <p class="copyright"> Copyright &copy; 2023 Themart by <a href="{{ route('root') }}">wpOceans</a>.
                        All
                        Rights Reserved.</p>
                </div>
            </div>
