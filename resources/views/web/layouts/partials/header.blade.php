                                ...
                                @if ($user)
                                    <div class="">
                                        <img src="{{ $user?->thumbnail }}" alt="" width="30"
                                            class="img-fluid"
                                            style="max-width: 30px; border-radius: 50%; object-fit: cover">
                                    </div>
                                    ...
                                    <div class="mini-cart-content">
                                        ...
                                        <div class="mini-cart-items">
                                            ...
                                            @foreach ($cartItems ?? [] as $cartItem)
                                                ...
                                                @endphp
                                                <div class="mini-cart-item clearfix">
                                                    <div class="mini-cart-item-image overflow-hidden">
                                                        <a
                                                            href="{{ route('singleProduct', $cartItem->product?->slug) }}"><img
                                                                src="{{ $cartItem->product?->thumbnail }}" alt></a>
                                                    </div>
                                                    <div class="mini-cart-item-des">
                                                        <a
                                                            href="{{ route('singleProduct', $cartItem->product?->slug) }}">{{ $cartItem->product?->name }}</a>
                                                        <span
                                                            class="mini-cart-item-price">${{ $cartItem->product?->discount_price > 0 ? $cartItem->product?->discount_price : $cartItem->product?->price }}
                                                            x
                                                            {{ $cartItem->quantity }}</span>
                                                        <span class="mini-cart-item-quantity"><a
                                                                href="{{ route('cart.delete', $cartItem->id) }}"><i
                                                                    class="ti-close"></i></a></span>
                                                    </div>
                                                </div>
                                            @endforeach
                                        ...
                                        <div class="mini-cart-action clearfix">
                                            ...
                                            <div class="mini-btn">
                                                <a href="{{ route('cartDetails') }}" class="view-cart-btn">View
                                                    Cart</a>
                                            </div>
                                        </div>
                                    </div>
