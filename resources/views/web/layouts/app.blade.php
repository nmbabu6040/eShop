                                ...
                                <div class="shape-text">Up To <div class="shape-single">
                                        <div class="shape">
                                            <svg width="158" height="159" viewBox="0 0 158 159" fill="none">
                                                ...
                                                <defs>
                                                    <linearGradient id="paint0_linear_62_180" x1="78.6428"
                                                        y1="0" x2="78.6428" y2="159"
                    ...
                    <div class="col-lg-6 col-12">
                        <ul class="special-product">
                            <li>
                                <div class="product-item">
                                    <div class="image">
                                        <img src="{{ asset('web/assets/images/special-product-1.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="text">
                    ...
                    <div class="col-lg-6 col-12">
                        <ul class="special-product">
                            <li>
                                <div class="product-item">
                                    <div class="image">
                                        <img src="{{ asset('web/assets/images/special-product-2.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="text">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="highlight-wrap">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('web/assets/images/recently-added/1.png') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="content">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('web/assets/images/recently-added/2.png') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="content">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('web/assets/images/recently-added/3.png') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="content">
                            ...
                            <div class="widget instagram">
                                ...
                                <ul class="d-flex">
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('web/assets/images/instragram/1.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('web/assets/images/instragram/2.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('web/assets/images/instragram/4.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('web/assets/images/instragram/3.jpg') }}"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img
                                                src="{{ asset('web/assets/images/instragram/4.jpg') }}"
                                                alt=""></a></li>
